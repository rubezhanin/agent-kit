...
def validate_release_artifacts() -> int:
    required = [
        ...
        ("scripts/check_orp.py", ROOT / "scripts" / "check_orp.py"),
        ("scripts/health_check.py", ROOT / "scripts" / "health_check.py"),
        ("scripts/check_release.py", ROOT / "scripts" / "check_release.py"),
        ("scripts/check_locale_sanity.py", ROOT / "scripts" / "check_locale_sanity.py"),
        ("agent-center/operations/origin-return-protocol/PROTOCOL.en.md",
         ROOT / "agent-center" / "operations" / "origin-return-protocol" / "PROTOCOL.en.md"),
        ("agent-center/operations/origin-return-protocol/PROTOCOL.ru.md",
         ROOT / "agent-center" / "operations" / "origin-return-protocol" / "PROTOCOL.ru.md"),
        ("agent-center/skills/operations/origin-return-protocol/SKILL.md",
         ROOT / "agent-center" / "skills" / "operations" / "origin-return-protocol" / "SKILL.md"),
